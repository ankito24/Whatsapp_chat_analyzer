...
def create_wordcloud(selected_user,df):
    ...
    temp = df[df['user'] != 'group_notification']  # temp ha no msgs of "group_notification"
    temp = temp[temp['message'] != '<Media omitted>\n']  # temp has no msgs like "media_omitted"
...
def monthly_timeline(selected_user,df):
    ...
    timeline['time'] = time  # now time added to timeline dataframe
    return timeline
...
def daily_timeline(selected_user,df):
    ...
    daily= df.groupby('date_only').count()['message'].reset_index()
    return daily
